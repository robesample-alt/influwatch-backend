...
function classifyCompensation(input) {
    ...
    const requiresPrincipalReview = supervisionPosture === 'CRITICAL' || supervisionPosture === 'HIGH';
    ...
    const precision = (0, compensationPrecision_1.normalizePrecisionOutput)((0, compensationPrecision_1.deriveCompensationPrecision)(input));
    return {
        isTransactionBased,
        isSecurityLinked,

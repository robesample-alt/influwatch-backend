...
async function main() {
  ...
  const promoterPosture: Record<string, string> = {
  ...
  const records = [
    ...
    { id: 'CR-DEMO-01', amb: 'AMB-DEMO-01', camp: 'CAMP-AGI', plat: 'YOUTUBE' as const, type: 'VIDEO' as const, status: 'ESCALATED' as const,
    ...
    { id: 'CR-DEMO-02', amb: 'AMB-DEMO-01', camp: 'CAMP-AGI', plat: 'YOUTUBE' as const, type: 'VIDEO' as const, status: 'PENDING_REVIEW' as const,
    ...
    { id: 'CR-DEMO-03', amb: 'AMB-DEMO-01', camp: 'CAMP-AGI', plat: 'YOUTUBE' as const, type: 'VIDEO' as const, status: 'CLOSED' as const,
    ...
    { id: 'CR-DEMO-04', amb: 'AMB-DEMO-01', camp: null, plat: 'YOUTUBE' as const, type: 'SHORT_FORM_VIDEO' as const, status: 'CAPTURED' as const,
    ...
    { id: 'CR-DEMO-05', amb: 'AMB-DEMO-01', camp: 'CAMP-AGI', plat: 'YOUTUBE' as const, type: 'VIDEO' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-06', amb: 'AMB-DEMO-02', camp: 'CAMP-HCD', plat: 'INSTAGRAM' as const, type: 'REEL' as const, status: 'ESCALATED' as const,
    ...
    { id: 'CR-DEMO-07', amb: 'AMB-DEMO-02', camp: 'CAMP-HCD', plat: 'INSTAGRAM' as const, type: 'IMAGE_POST' as const, status: 'PENDING_REVIEW' as const,
    ...
    { id: 'CR-DEMO-08', amb: 'AMB-DEMO-02', camp: 'CAMP-HCD', plat: 'INSTAGRAM' as const, type: 'STORY' as const, status: 'CAPTURED' as const,
    ...
    { id: 'CR-DEMO-09', amb: 'AMB-DEMO-02', camp: 'CAMP-HCD', plat: 'INSTAGRAM' as const, type: 'CAROUSEL' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-10', amb: 'AMB-DEMO-03', camp: 'CAMP-MTL', plat: 'TIKTOK' as const, type: 'SHORT_FORM_VIDEO' as const, status: 'PENDING_REVIEW' as const,
    ...
    { id: 'CR-DEMO-11', amb: 'AMB-DEMO-03', camp: 'CAMP-MTL', plat: 'TIKTOK' as const, type: 'SHORT_FORM_VIDEO' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-12', amb: 'AMB-DEMO-03', camp: 'CAMP-MTL', plat: 'TIKTOK' as const, type: 'SHORT_FORM_VIDEO' as const, status: 'CAPTURED' as const,
    ...
    { id: 'CR-DEMO-13', amb: 'AMB-DEMO-03', camp: null, plat: 'TIKTOK' as const, type: 'SHORT_FORM_VIDEO' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-14', amb: 'AMB-DEMO-04', camp: 'CAMP-AGI', plat: 'TWITTER_X' as const, type: 'TWEET' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-15', amb: 'AMB-DEMO-04', camp: 'CAMP-AGI', plat: 'TWITTER_X' as const, type: 'THREAD' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-16', amb: 'AMB-DEMO-04', camp: 'CAMP-AGI', plat: 'TWITTER_X' as const, type: 'TWEET' as const, status: 'CAPTURED' as const,
    ...
    { id: 'CR-DEMO-17', amb: 'AMB-DEMO-04', camp: null, plat: 'TWITTER_X' as const, type: 'TWEET' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-18', amb: 'AMB-DEMO-05', camp: 'CAMP-HCD', plat: 'YOUTUBE' as const, type: 'VIDEO' as const, status: 'ESCALATED' as const,
    ...
    { id: 'CR-DEMO-19', amb: 'AMB-DEMO-05', camp: 'CAMP-HCD', plat: 'YOUTUBE' as const, type: 'VIDEO' as const, status: 'PENDING_REVIEW' as const,
    ...
    { id: 'CR-DEMO-20', amb: 'AMB-DEMO-05', camp: 'CAMP-HCD', plat: 'YOUTUBE' as const, type: 'VIDEO' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-21', amb: 'AMB-DEMO-05', camp: null, plat: 'YOUTUBE' as const, type: 'VIDEO' as const, status: 'CAPTURED' as const,
    ...
    { id: 'CR-DEMO-22', amb: 'AMB-DEMO-06', camp: null, plat: 'TWITTER_X' as const, type: 'TWEET' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-23', amb: 'AMB-DEMO-06', camp: null, plat: 'TWITTER_X' as const, type: 'TWEET' as const, status: 'REVIEWED' as const,
    ...
    { id: 'CR-DEMO-24', amb: 'AMB-DEMO-06', camp: null, plat: 'TWITTER_X' as const, type: 'THREAD' as const, status: 'CAPTURED' as const,
    ...
    { id: 'CR-DEMO-25', amb: 'AMB-DEMO-07', camp: 'CAMP-AGI', plat: 'INSTAGRAM' as const, type: 'IMAGE_POST' as const, status: 'ESCALATED' as const,
    ...
    { id: 'CR-DEMO-26', amb: 'AMB-DEMO-07', camp: null, plat: 'INSTAGRAM' as const, type: 'REEL' as const, status: 'PENDING_REVIEW' as const,
    ...
    { id: 'CR-DEMO-27', amb: 'AMB-001', camp: 'CAMP-AGI', plat: 'INSTAGRAM' as const, type: 'REEL' as const, status: 'PENDING_REVIEW' as const,
    ...
    // Elena Park (AMB-002)
    { id: 'CR-DEMO-28', amb: 'AMB-002', camp: 'CAMP-HCD', plat: 'YOUTUBE' as const, type: 'VIDEO' as const, status: 'CAPTURED' as const,
    ...
    // Alex Tran (AMB-003)
    { id: 'CR-DEMO-29', amb: 'AMB-003', camp: 'CAMP-MTL', plat: 'TWITTER_X' as const, type: 'TWEET' as const, status: 'CAPTURED' as const,
  ...
  const maxSev = (a: string, b: string) => (SEV_RANK[a] >= SEV_RANK[b] ? a : b);
  const postureFloorSeverity = (posture: string): string => {
    ...
    if (posture === 'CRITICAL') return 'MEDIUM';
    return 'LOW';
  };

  for (const rec of records) {
    const checksum = computeChecksum(rec.url, rec.body);
    const hits = detectRuleHits(rec.body);
    const detectionSev = hits.length > 0
      ? (['CRITICAL', 'HIGH', 'MEDIUM', 'LOW'].find(s => hits.some(h => h.severity === s)) as Severity || 'LOW')
      : 'LOW';
    const posture  = promoterPosture[rec.amb] || 'LOW';
    const floorSev = postureFloorSeverity(posture);
    const finalSev = maxSev(detectionSev, floorSev) as Severity;
  ...
  const escalations = [
    ...
    { id: 'EVT-DEMO-ESC-01', record: 'CR-DEMO-01', type: ArchiveEventType.ESCALATION_RAISED,
    ...
    { id: 'EVT-DEMO-ESC-02', record: 'CR-DEMO-01', type: ArchiveEventType.COMPLIANCE_ESCALATED,
    ...
    { id: 'EVT-DEMO-ESC-03', record: 'CR-DEMO-06', type: ArchiveEventType.ESCALATION_RAISED,
    ...
    { id: 'EVT-DEMO-ESC-04', record: 'CR-DEMO-06', type: ArchiveEventType.COMPLIANCE_PROMOTER_SUSPENDED,
    ...
    { id: 'EVT-DEMO-ESC-05', record: 'CR-DEMO-18', type: ArchiveEventType.ESCALATION_RAISED,
    ...
    { id: 'EVT-DEMO-ESC-06', record: 'CR-DEMO-25', type: ArchiveEventType.ESCALATION_RAISED,
  ...
  const remediationEvents = [
    { id: 'EVT-DEMO-REM-01', record: 'CR-DEMO-03', type: ArchiveEventType.REVIEW_STARTED,
      note: 'Review initiated — content flagged for performance language but contains required disclaimers.', actor: 'IA-003' },
    { id: 'EVT-DEMO-REM-02', record: 'CR-DEMO-03', type: ArchiveEventType.REVIEW_COMPLETED,
    ...
    { id: 'EVT-DEMO-REM-03', record: 'CR-DEMO-03', type: ArchiveEventType.COMPLIANCE_APPROVED,
    ...
    { id: 'EVT-DEMO-REM-04', record: 'CR-DEMO-03', type: ArchiveEventType.COMPLIANCE_CERTIFIED,
    ...
    { id: 'EVT-DEMO-REM-05', record: 'CR-DEMO-09', type: ArchiveEventType.REVIEW_STARTED,
      note: 'Review initiated — educational content with proper disclosures.', actor: 'IA-002' },
    { id: 'EVT-DEMO-REM-06', record: 'CR-DEMO-09', type: ArchiveEventType.COMPLIANCE_APPROVED,

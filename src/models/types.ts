...
export interface ContentRecordResponse {
  ...
  detectionRecords?: DetectionRecordResponse[];  // populated on detail endpoint only
...
export type ComplianceActionType =
  ...
  | 'SUSPEND_PROMOTER'
  | 'ESCALATE'
  | 'CERTIFY';    // Supervisory sign-off — formally closes the compliance case

export const VALID_COMPLIANCE_ACTIONS: ComplianceActionType[] = [
  'APPROVE',
  'REQUEST_EDIT',
  'WARN_PROMOTER',
  'SUSPEND_PROMOTER',

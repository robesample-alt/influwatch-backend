...
const PHRASE_MAP: Record<string, PhraseDef> = {
  ...
  'commission-free':       { ruleCode: 'FINTECH-001', ruleName: 'Fee Misrepresentation', severity: Severity.MEDIUM },
  'no fees':               { ruleCode: 'FINTECH-001', ruleName: 'Fee Misrepresentation', severity: Severity.MEDIUM },
  'free trading':          { ruleCode: 'FINTECH-001', ruleName: 'Fee Misrepresentation', severity: Severity.MEDIUM },
  'zero commission':       { ruleCode: 'FINTECH-001', ruleName: 'Fee Misrepresentation', severity: Severity.MEDIUM },
  'no commissions':        { ruleCode: 'FINTECH-001', ruleName: 'Fee Misrepresentation', severity: Severity.MEDIUM },
  'trade for free':        { ruleCode: 'FINTECH-001', ruleName: 'Fee Misrepresentation', severity: Severity.MEDIUM },
  'no trading fees':       { ruleCode: 'FINTECH-001', ruleName: 'Fee Misrepresentation', severity: Severity.MEDIUM },

  // ── FINTECH-002 — Account Opening Solicitation ────────────
  'open an account':       { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'sign up with my link':  { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'use my code':           { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'use my link':           { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'open and fund':         { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'get free stocks':       { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'free stock when you sign up': { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'bonus when you fund':   { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'referral bonus':        { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'sign-up bonus':         { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },
  'deposit bonus':         { ruleCode: 'FINTECH-002', ruleName: 'Account Opening Solicitation', severity: Severity.HIGH },

  // ── FINTECH-003 — Performance Claims ──────────────────────
  'my portfolio':          { ruleCode: 'FINTECH-003', ruleName: 'Promoter Performance Claims', severity: Severity.HIGH },
  'my returns':            { ruleCode: 'FINTECH-003', ruleName: 'Promoter Performance Claims', severity: Severity.HIGH },
  "i've been making":      { ruleCode: 'FINTECH-003', ruleName: 'Promoter Performance Claims', severity: Severity.HIGH },
  'earning every week':    { ruleCode: 'FINTECH-003', ruleName: 'Promoter Performance Claims', severity: Severity.HIGH },

  // ── FINTECH-004 — Promissory Language ─────────────────────
  "you'll make money":     { ruleCode: 'FINTECH-004', ruleName: 'Promissory Language', severity: Severity.CRITICAL },
  'this works':            { ruleCode: 'FINTECH-004', ruleName: 'Promissory Language', severity: Severity.CRITICAL },
  'guaranteed':            { ruleCode: 'FINTECH-004', ruleName: 'Promissory Language', severity: Severity.CRITICAL },
  'never lost':            { ruleCode: 'FINTECH-004', ruleName: 'Promissory Language', severity: Severity.CRITICAL },
  'always profitable':     { ruleCode: 'FINTECH-004', ruleName: 'Promissory Language', severity: Severity.CRITICAL },
  'risk-free':             { ruleCode: 'FINTECH-004', ruleName: 'Promissory Language', severity: Severity.CRITICAL },
  'you will profit':       { ruleCode: 'FINTECH-004', ruleName: 'Promissory Language', severity: Severity.CRITICAL },
  'proven strategy':       { ruleCode: 'FINTECH-004', ruleName: 'Promissory Language', severity: Severity.CRITICAL },

  // ── FINTECH-005 — Urgency / Artificial Scarcity ───────────
  'limited time':          { ruleCode: 'FINTECH-005', ruleName: 'Urgency / Artificial Scarcity', severity: Severity.MEDIUM },
  'bonus expires':         { ruleCode: 'FINTECH-005', ruleName: 'Urgency / Artificial Scarcity', severity: Severity.MEDIUM },
  'offer ends':            { ruleCode: 'FINTECH-005', ruleName: 'Urgency / Artificial Scarcity', severity: Severity.MEDIUM },
  'only available until':  { ruleCode: 'FINTECH-005', ruleName: 'Urgency / Artificial Scarcity', severity: Severity.MEDIUM },
  'act now':               { ruleCode: 'FINTECH-005', ruleName: 'Urgency / Artificial Scarcity', severity: Severity.MEDIUM },
  "don't miss out":        { ruleCode: 'FINTECH-005', ruleName: 'Urgency / Artificial Scarcity', severity: Severity.MEDIUM },

  // ── REGCF-001 — Portal-Prohibited Solicitation ─────────────
  'you should invest':     { ruleCode: 'REGCF-001', ruleName: 'Portal-Prohibited Solicitation', severity: Severity.CRITICAL },
  'i recommend investing': { ruleCode: 'REGCF-001', ruleName: 'Portal-Prohibited Solicitation', severity: Severity.CRITICAL },
  'this is a good investment': { ruleCode: 'REGCF-001', ruleName: 'Portal-Prohibited Solicitation', severity: Severity.CRITICAL },
  'great investment opportunity': { ruleCode: 'REGCF-001', ruleName: 'Portal-Prohibited Solicitation', severity: Severity.CRITICAL },
  "i'm investing in":     { ruleCode: 'REGCF-001', ruleName: 'Portal-Prohibited Solicitation', severity: Severity.CRITICAL },
  'you need to invest':   { ruleCode: 'REGCF-001', ruleName: 'Portal-Prohibited Solicitation', severity: Severity.CRITICAL },

  // ── REGCF-002 — Equity/Ownership Solicitation ─────────────
  'own equity in':         { ruleCode: 'REGCF-002', ruleName: 'Equity/Ownership Solicitation', severity: Severity.HIGH },
  'become an investor':    { ruleCode: 'REGCF-002', ruleName: 'Equity/Ownership Solicitation', severity: Severity.HIGH },
  'get equity':            { ruleCode: 'REGCF-002', ruleName: 'Equity/Ownership Solicitation', severity: Severity.HIGH },
  'own a piece of':        { ruleCode: 'REGCF-002', ruleName: 'Equity/Ownership Solicitation', severity: Severity.HIGH },
  'invest as little as':   { ruleCode: 'REGCF-002', ruleName: 'Equity/Ownership Solicitation', severity: Severity.HIGH },
  'own shares in':         { ruleCode: 'REGCF-002', ruleName: 'Equity/Ownership Solicitation', severity: Severity.HIGH },
  'become a shareholder':  { ruleCode: 'REGCF-002', ruleName: 'Equity/Ownership Solicitation', severity: Severity.HIGH },
  'claim your equity':     { ruleCode: 'REGCF-002', ruleName: 'Equity/Ownership Solicitation', severity: Severity.HIGH },

  // ── REGCF-003 — Investment Limit Misrepresentation ────────
  'invest as much as you want': { ruleCode: 'REGCF-003', ruleName: 'Investment Limit Misrepresentation', severity: Severity.CRITICAL },
  'no limit on investment': { ruleCode: 'REGCF-003', ruleName: 'Investment Limit Misrepresentation', severity: Severity.CRITICAL },
  'invest any amount':     { ruleCode: 'REGCF-003', ruleName: 'Investment Limit Misrepresentation', severity: Severity.CRITICAL },
  'unlimited investment':  { ruleCode: 'REGCF-003', ruleName: 'Investment Limit Misrepresentation', severity: Severity.CRITICAL },
  'invest whatever you want': { ruleCode: 'REGCF-003', ruleName: 'Investment Limit Misrepresentation', severity: Severity.CRITICAL },

  // ── REGCF-004 — Campaign Urgency / Artificial Scarcity ────
  'campaign closes':       { ruleCode: 'REGCF-004', ruleName: 'Campaign Urgency / Artificial Scarcity', severity: Severity.MEDIUM },
  'funding deadline':      { ruleCode: 'REGCF-004', ruleName: 'Campaign Urgency / Artificial Scarcity', severity: Severity.MEDIUM },
  'almost fully funded':   { ruleCode: 'REGCF-004', ruleName: 'Campaign Urgency / Artificial Scarcity', severity: Severity.MEDIUM },
  'last chance to invest': { ruleCode: 'REGCF-004', ruleName: 'Campaign Urgency / Artificial Scarcity', severity: Severity.MEDIUM },
  ...
  'only platform of its kind': { ruleCode: 'REGCF-005', ruleName: 'Misleading Issuer Claims', severity: Severity.HIGH },
  'revolutionary technology': { ruleCode: 'REGCF-005', ruleName: 'Misleading Issuer Claims', severity: Severity.HIGH },
  'proven business model': { ruleCode: 'REGCF-005', ruleName: 'Misleading Issuer Claims', severity: Severity.HIGH },
...
//
// Optional second argument to detectRuleHits.
// Passed at ingestion when the promoter's CompensationStructure
// has been resolved. Enables COMP-001, COMP-002, COMP-003 evaluation.
// Callers that do not supply this argument get phrase-only detection.
// ─────────────────────────────────────────
...
const OWNERSHIP_DISCLOSURE_PATTERNS: string[] = [
  'i own shares',
  'i am a shareholder',
  'i have equity',
  'i receive equity',
...
const RISK_004_TRIGGERS: string[] = [
  'will grow',
  'will increase',
  'will outperform',
  'will generate',
...
const RISK_004_DISCLAIMERS: string[] = [
  'past performance',
...
const RISK_005_TRIGGERS: string[] = [
  'i made',
  'i earned',
  'i returned',
  'i profited',
...
const RISK_005_DISCLOSURES: string[] = [
  'results not typical',
 ...
 */
export function detectRuleHits(bodyText: string, compensationCtx?: CompensationContext): RuleHit[] {
  if (!bodyText) return [];
  ...
  if (compensationCtx && COMP_003_FORMS.has(compensationCtx.compensationForm)) {
    const hasOwnershipDisclosure = OWNERSHIP_DISCLOSURE_PATTERNS.some(p =>
...
// ─────────────────────────────────────────
// RULE METADATA — safe for API exposure
//
// Returns rule metadata WITHOUT phrase content.
// Only the count of patterns is included, never
// the patterns themselves. This is a hard IP
// protection boundary.
// ─────────────────────────────────────────

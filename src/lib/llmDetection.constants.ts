...
export const LLM_RULE_CODE_SET: ReadonlySet<string> = new Set(LLM_RULE_CODES);
 ...
 */
export const LLM_RULE_CODE_CATEGORY: Record<LlmRuleCode, string> = {
 ...
 */
export const LLM_RULE_CODE_NAME: Record<LlmRuleCode, string> = {
 ...
 */
export const LLM_SEVERITY_CEILING: Record<LlmRuleCode, Severity> = {
  'LLM-001': 'CRITICAL',
  'LLM-002': 'HIGH',
  'LLM-003': 'CRITICAL',
  'LLM-004': 'HIGH',
 ...
 */
export function clampLlmSeverity(ruleCode: LlmRuleCode, candidate: Severity): Severity {
  const ceiling = LLM_SEVERITY_CEILING[ruleCode];
 ...
 */
export function describePosture(opts: {
